...
#from ..src.Constants import CUTOFF_TIME, Race
import Constants
...
class TestPlayer(unittest.TestCase):
    ...
    def test_initialise(self):
        ...
        player1: Player = Player.Player(has_replay, 1, Constants.CUTOFF_TIME)
        player2: Player = Player.Player(has_replay, 2, Constants.CUTOFF_TIME)
